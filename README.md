...
**Book Store App** is a directory which you can add new books delete them and keep books with a interactive UI and a SPA containing 2 page.
...
- [ ] **Ability to add PDF**
- [ ] **Ability to add book mark to books till the page you readed**
